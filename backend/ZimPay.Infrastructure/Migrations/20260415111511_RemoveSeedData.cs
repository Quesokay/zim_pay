    ...
    public partial class RemoveSeedData : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Balance", "CreatedAt", "Email", "IsActive", "Name", "Phone", "TapLimit", "UpdatedAt" },
                values: new object[] { 1, 1500.00m, new DateTime(2024, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "john.doe@example.com", true, "John Doe", "+1234567890", 50.00m, null });
            ...
            migrationBuilder.InsertData(
                table: "PaymentMethods",
                columns: new[] { "Id", "AccountNumber", "AddedAt", "BankName", "CardNumber", "DigitalToken", "ExpiryDate", "HolderName", "IsActive", "IsDefault", "Type", "UpdatedAt", "UserId" },
                values: new object[] { 1, "", new DateTime(2024, 10, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Bank of Future", "8892", "seeded_dummy_jwt_token_for_testing", "12/28", "", true, true, "CreditCard", null, 1 });
        }
    }
}
